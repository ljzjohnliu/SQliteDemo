package com.example.lzc.sqlitedemo.OpenHelper;
...
public class DataOpenHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sql = "create table "+ DBConfig.TABLE_NAME+"("+DBConfig.DB_ID+" integer primary key,"
                +DBConfig.FIRST_COLUMNS+" text,"+DBConfig.NEXT_COLUMNS+" text);";
